...
var arrayOfChineseQuestions: [Question] = [
    Question(question: "你几时需要发电邮？", input: "", options: ["选择", "早上", "下午", "傍晚"], questionType:"Basic Info"),
    ...
    Question(question: "问候", input: "", options: ["选择", "亲爱的[名字]", "亲爱的[职位]", "敬启者", "问候[名字]", " [早上 / 下午 / 晚上 ]好[名字]", "你好[名字]"], questionType:"Greeting"),
    Question(question: "电子邮件的目的是什么?", input: "", questionType:"Greeting"),
    
    Question(question: "点", input: "", questionType:"Content"),
    Question(question: "动词", input: "", options: ["选择", "通知", "问", "查询", "提倡", "提出"], questionType:"Content"),
    ...
    Question(question: "结束语", input: "", options: ["选择", "祝", "此致","谢谢", "提早感谢", "干杯"], questionType:"Closing"),
